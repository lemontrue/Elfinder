...
namespace ElFinder
{
    ...
    internal class DefaultPicturesEditor : IPicturesEditor
    {
        ...
        public virtual void Resize(string file, int width, int height)
        {
        ...
        public virtual void Crop(string file, int x, int y, int width, int height)
        {
            ImageWithMime output;
            using (Image inputImage = Image.FromFile(file))
            {
        ...
        public virtual void Rotate(string file, int angle)
        {
            ImageWithMime output;
            using (Image inputImage = Image.FromFile(file))
            {
        ...
        protected ImageWithMime ScaleOrCrop(Image inputImage, Rectangle src, Rectangle dst)
        {
        ...
        protected ImageWithMime Rotate(Image image, float angle)
        {
            if (image == null)
        ...
        protected ImageWithMime SaveImage(Bitmap inputImage, ImageFormat imageFormat)
        {
