...
Crypt.Dialog = function() {
  ...
  return {
    ...
    tpl: {
      ...
      iframe: '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0"' + ((ref = $.browser.msie) != null ? ref : {
    ...
    Open: function(type, data, options) {
      ...
      switch (type) {
        ...
        case 'blankInfo2':
          fbOptions.wrapCSS = 'info-modal';
          template = $('#tpl-blankInfo2').text();
          html = _.template(template)(data);
          break;
        case 'blankInfo3':
          fbOptions.wrapCSS = 'info-modal';
          template = $('#tpl-blankInfo3').text();
          html = _.template(template)(data);
          break;
        case 'blankCentered':
          ...
          break;
        case 'blankInform':
          fbOptions.wrapCSS = 'inform-modal';
          template = $('#tpl-blankInform').text();
          html = _.template(template)(data);
          break;
        case 'blankConfirm':
          fbOptions.wrapCSS = 'confirm-modal';
          template = $('#tpl-blankConfirm').text();
          html = _.template(template)(data);
          break;
        default:
