 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-borderimage-borderradius-boxshadow-flexbox-flexboxlegacy-hsla-multiplebgs-opacity-rgba-textshadow-csscolumns-csstransforms3d-shiv-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
;
window.Modernizr = function(a, b, c) {
    ...
    !A(w, "undefined") && !A(w.call, "undefined") ? x = function(a, b) { return w.call(a, b); } : x = function(a, b) { return b in a && A(a.constructor.prototype[b], "undefined"); }, Function.prototype.bind || (Function.prototype.bind = function(b) {
        ...
        return e;
    }), p.flexbox = function() { return E("flexWrap"); }, p.flexboxlegacy = function() { return E("boxDirection"); }, p.rgba = function() { return y("background-color:rgba(150,255,150,.5)"), B(i.backgroundColor, "rgba"); }, p.hsla = function() { return y("background-color:hsla(120,40%,100%,.5)"), B(i.backgroundColor, "rgba") || B(i.backgroundColor, "hsla"); }, p.multiplebgs = function() { return y("background:url(https://),url(https://),red url(https://)"), /(url\s*\(.*?){3}/.test(i.background); }, p.backgroundsize = function() { return E("backgroundSize"); }, p.borderimage = function() { return E("borderImage"); }, p.borderradius = function() { return E("borderRadius"); }, p.boxshadow = function() { return E("boxShadow"); }, p.textshadow = function() { return b.createElement("div").style.textShadow === ""; }, p.opacity = function() { return z("opacity:.55"), /^0.55$/.test(i.opacity); }, p.csscolumns = function() { return E("columnCount"); }, p.csstransforms3d = function() {
        var a = !!E("perspective");
    ...
    return e.addTest = function(a, b) {
        ...
        a.html5 = s, r(b);
    }(this, b), e._version = d, e._prefixes = l, e._domPrefixes = o, e._cssomPrefixes = n, e.testProp = function(a) { return C([a]); }, e.testAllProps = E, e.testStyles = v, e;
